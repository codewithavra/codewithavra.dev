  ...
  return (
    <div className='bdr-box mx-auto h-fit w-full max-w-3xl border-x'>
      {CERTIFICATES.map((item) => {
        return (
          <div className='bdr-box flex h-20 w-full border-b' key={item.id}>
            ...
            <div className='flex h-full w-full flex-col p-2 justify-start items-center gap-1'>
                <h3 className="w-full">{item.label}</h3>
                <div className="flex gap-2 w-full h-fit  text-xs text-foreground/50">
