...
const Menu = () => {
  return (
    <div className="fixed bottom-20 left-1/2 -translate-x-1/2 h-fit w-fit border border-foreground/20 z-40 rounded-card bg-background/80 backdrop-blur-lg text-foreground p-8 flex flex-col justify-center items-center gap-2 md:hidden">
        {
            NAV_ITEMS.map((item)=>{
