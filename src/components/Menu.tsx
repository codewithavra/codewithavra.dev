...
const Menu = () => {
  return (
    <div className="fixed top-17 right-2 h-fit w-fit border border-foreground/20 z-40 rounded-card bg-background/80 backdrop-blur-xs text-foreground p-8 flex flex-col justify-center items-center gap-2">
        {
            NAV_ITEMS.map((item)=>{
